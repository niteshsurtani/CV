...
{\color[HTML]{444444}
\textsuperscript{$*$} {\it I have taken another test (results: \textbf{Dec 9\textsuperscript{th}}), hoping to improve my current scores.}
}
...
\item{November 2013 -- Present}
     {}
     {\href{https://github.com/pooriaazimi/Translatr}{Translatr}}
	 {My Thesis project -- An online, computer-assisted, translation manager software that would help teams of translators with their jobs by providing features like automatic translation, spell- and grammar-checking, terminology manager, and translation memory.}
     {%
