...
For much of the past 3 years, I have been working closely with Dr.\ Khadivi on multiple projects (Kavandeh, VPS, Baygan), Berlin Data Mining Cup, and now my thesis project. I have also been a Teacher Assistant for two of Dr.\ Khadivi's courses (3 years for ``Database Design'' and one semester for ``Data Mining'').
\\[7pt]
\uline{More references are available upon request}.
%, of course, but I've included only Dr.\ Khadivi's address above because I think he is in the best position to judge my academic and technical background.
