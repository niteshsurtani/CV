...
\\
{\it Our team created a bidding agent in Java for the \mbox{``online''} task, and used a combination of statistical models, \mbox{neural} networks and SVMs for predicting the results of the \mbox{``offline''} task.}
...
\item{July 2011 -- April 2012}
	 ...
	 \\[1.5pt]
	 Our team of two heavily improved upon Nutch's \mbox{scoring}, ranking, parsing, crawling, and spam detection submodules, and used WebKit's rendering engine for detecting semantically siugnificant parts of a (rendered) Web page and weighting links in these areas proportionally (this \mbox{latter} scheme was dropped eventually due to its being computationally expensive).}
     {%
...
\item{March 2012 -- June 2012}
	 ...
	 {Detecting Web page structure with statistical \mbox{analysis} of the visual representation of the rendered page content, and using that structure for improving ranking algorithms in a search engine.\\[1.5pt]%
...
%
\vspace{-3pt}
For much of the past 3 years, and also the coming year, I have been working closely with Dr.\ Khadivi on multiple projects (Kavandeh, VPS, Baygan), Berlin Data \mbox{Mining} Cup, and now my thesis project. I have also been a Teacher Assistant for two of Dr.\ Khadivi's courses (``Database Design'': three years, ``Data Mining'': one semester).
\\[6pt]
