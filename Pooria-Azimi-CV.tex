...
\begin{table}[ph]
  \centering
	\begin{tabular}{C{3.5cm}|C{4cm}}
 	   {\sc TOEFL }i{\sc BT} & {\sc GRE General (\uline{expected}\textsuperscript{$*$})}\\[5px]
	   \hline
...
\medskip\\
\textsuperscript{$**$} {\it I'm taking another iBT test (with the results being made on {\bf November 12\textsuperscript{th}}) to improve my score in the Speaking section.}
