...
\item{June and July 2010}
	 ...
	 {A complete, single-purpose search engine (all parts \mbox{written} from scratch), designed to use minimal online memory (60MB), for indexing and searching the contents of the English Wikipedia.}
	 {%
		 \href{http://www.oracle.com/technetwork/java/}{Java}%
	 }
