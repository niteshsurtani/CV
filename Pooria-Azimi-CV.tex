...
{\color[HTML]{444444}
\textsuperscript{$*$} {\it Only the paper-based GRE test is administrated in Iran (results: \textbf{Dec 9\textsuperscript{th}}). The above table is my \uline{expected} scores based on a few (official and ETS-provided) prep tests.}
\medskip\\
