...
\item EPFL/Typesafe Inc.'s \href{https://www.coursera.org/course/reactive}{Principles of Reactive\\ Programming} {\it(2013 -- by \href{https://en.wikipedia.org/wiki/Martin_Odersky}{Martin Odersky}, \mbox{et al.})}
...
\begin{description}
%
\item[Dr. Shahram Khadivi] (Assistant Professor, Amirkabir University of Technology, Iran)
\\
...
%
\item[Dr. Mehdi Ebadzadeh] (Associate Professor, \mbox{Amirkabir} University of Technology, Iran)
\\
\href{http://ceit.aut.ac.ir/~ebadzadeh/}{http://ceit.aut.ac.ir/{\tilde}ebadzadeh/} -- \href{mailto:ebadzadeh@aut.ac.ir}{Email}
%
\item[Dr. Mohammad Rahmati] (Associate Professor, \\Amirkabir University of Technology, Iran)
\\
...
%
\item[Salim Malakouti] (Ph.D. Student, Pittsburgh \mbox{University}, PA, USA)
\\
\href{http://people.cs.pitt.edu/~salimm/}{Website} -- \href{mailto:salim.malakouti@gmail.com}{Email}
%
\item[Ali Ghanbari] (M.Sc. Student, Amirkabir \mbox{University} of Technology, Iran) -- \href{mailto:ali.ghanbari@aut.ac.ir}{Email}
%
\end{description}
